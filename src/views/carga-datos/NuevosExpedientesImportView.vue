  ...
  <div class="min-h-[80vh] flex flex-col items-center justify-center p-4">
    ...
    <div class="max-w-4xl w-full bg-white dark:bg-gray-800 rounded-3xl shadow-[0px_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-2/5 bg-slate-50 dark:bg-gray-900/50 p-8 flex flex-col justify-between border-r border-gray-100 dark:border-gray-700">
            <div>
                <div class="flex items-center justify-center w-12 h-12 bg-indigo-100 text-indigo-600 rounded-2xl mb-6 shadow-inner">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border border-indigo-100 dark:border-gray-700 relative overflow-hidden">
                    ...
                    <ol class="relative border-l border-gray-200 dark:border-gray-700 ml-2 space-y-6">                  
                        ...
                        <li class="ml-4">
                            <div class="absolute w-3 h-3 bg-indigo-500 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900"></div>
                            <h4 class="text-sm font-semibold text-indigo-600">3. Inicia el Proceso</h4>
        ...
        <div class="w-full md:w-3/5 p-8 bg-white dark:bg-gray-800">
            <div class="max-w-md mx-auto h-full flex flex-col justify-center">
                ...
                <div 
                    ...
                    @dragover.prevent
                    class="group relative border-2 border-dashed border-gray-300 dark:border-gray-600 hover:border-indigo-500 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/10 rounded-2xl p-10 transition-all duration-300 cursor-pointer flex flex-col items-center justify-center text-center gap-4"
                >
                    <div class="w-16 h-16 bg-indigo-50 dark:bg-indigo-900/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-8 h-8 text-indigo-500" width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            o <span class="text-indigo-600 underline font-medium">haz clic para explorar</span>
                        </p>
                    </div>
                ...
                <div class="mt-8 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="group">
                            ...
                            <input v-model="form.desde" type="date"
                                class="w-full bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all dark:text-white">
                        </div>
                        <div class="group">
                    ...
                    <div v-if="importStore.progress > 0 || importStore.isUploading" class="mb-4">
                        <div class="flex justify-between text-xs mb-1">
                            ...
                            <span class="text-indigo-600 font-bold">{{ importStore.statusMessage || 'Procesando...' }}</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                            <div class="bg-indigo-600 h-2.5 rounded-full transition-all duration-500" :style="{ width: '100%' }"></div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <button 
                            ...
                            class="flex-1 px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white rounded-lg text-sm font-medium shadow-lg shadow-indigo-500/30 disabled:opacity-50 disabled:shadow-none disabled:active:scale-100 transition-all flex justify-center items-center gap-2"
                        >
