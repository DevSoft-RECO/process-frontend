                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700/50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Fecha Recibido</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        <tr v-if="loading" class="animate-pulse">
                            <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">Cargando expedientes...</td>
                        </tr>
                        <tr v-else-if="expedientes.length === 0">
                            <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-base font-medium text-gray-900 dark:text-gray-200">No hay expedientes en buzón</p>
                                    <p class="text-sm mt-1">Actualmente no hay solicitudes pendientes en este estado.</p>
                                </div>
                            </td>
                        </tr>
                         <tr v-for="exp in expedientes" :key="exp.codigo_cliente" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-700 dark:text-gray-300">
                                    {{ exp.fecha_inicio ? new Date(exp.fecha_inicio + 'T00:00:00').toLocaleDateString('es-ES') : 'N/A' }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                             ...
                             <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div v-if="exp.fechas?.f_enviado_protocolos" class="text-xs text-gray-500">
