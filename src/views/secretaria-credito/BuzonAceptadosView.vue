    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <Encabezado
                    title="Buzón Aceptados"
                    subtitle="Expedientes aceptados por Secretaría Crédito."
                        ...
                        <tr v-else-if="expedientes.length === 0">
                            <td colspan="7" class="px-6 py-12 text-center text-slate-400">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-base font-medium text-slate-500 dark:text-slate-400">No hay expedientes aceptados</p>
                                </div>
                            </td>
                        </tr>
