            ...
            <tr v-for="item in items" :key="item.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <template v-if="canDeliver(item)">
                    <button 
                      class="bg-blue-100 text-blue-700 hover:bg-blue-200 px-4 py-2 rounded text-xs font-bold border border-blue-300 transition-colors opacity-50 cursor-not-allowed"
