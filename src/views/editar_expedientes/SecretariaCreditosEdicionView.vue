        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                    ...
                    Edición de Expedientes (Secretaría Créditos)
                </h1>
...
const search = async () => {
    ...
    try {
        ...
        if (res.data.success) {
            ...
            // Validación de estado para Crétitos: Solo se permiten ediciones en estados 5 y 7.
            // Si el estado NO es 5 ni 7 y el usuario NO es Super Admin, se bloquea.
            const allowedStates = [5, 7]
            if (!allowedStates.includes(exp.id_estado) && !userStore.hasRole('Super Admin')) {
                Swal.fire({
                    icon: 'info',
                    title: 'Expediente Fuera de Etapa',
                    text: 'El expediente ha avanzado o no se encuentra en la etapa de créditos. Cualquier cambio debe solicitarlo a Informática.',
            ...
            Swal.fire({
             ...
             Swal.fire({
                ...
                text: 'No se encontró un expediente con los criterios ingresados.',
                confirmButtonText: 'Entendido'
            })
        }
    } catch (error: any) {
