                                ...
                                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8" v-if="g.pivot">
                                    ...
                                    <div>
                                        <h4 class="text-[10px] font-black text-gray-400 uppercase mb-3 flex items-center gap-2 tracking-widest">
                                            <svg class="w-3 h-3 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                                            Principales / Codeudores
                                        </h4>
                                        <ul class="space-y-2 text-sm">
                                            <li v-if="g.pivot.codeudor1" class="flex items-start gap-2 text-gray-700 dark:text-gray-300 bg-gray-50/50 dark:bg-gray-700/30 p-2 rounded border border-gray-100 dark:border-gray-700/50">
                                                <span class="text-gray-400 text-xs font-bold mt-0.5">1.</span>
                                                <span class="font-medium">{{ g.pivot.codeudor1 }}</span>
                                            </li>
                                            <li v-if="g.pivot.codeudor2" class="flex items-start gap-2 text-gray-700 dark:text-gray-300 bg-gray-50/50 dark:bg-gray-700/30 p-2 rounded border border-gray-100 dark:border-gray-700/50">
                                                <span class="text-gray-400 text-xs font-bold mt-0.5">2.</span>
                                                <span class="font-medium">{{ g.pivot.codeudor2 }}</span>
                                            </li>
                                            <li v-if="g.pivot.codeudor3" class="flex items-start gap-2 text-gray-700 dark:text-gray-300 bg-gray-50/50 dark:bg-gray-700/30 p-2 rounded border border-gray-100 dark:border-gray-700/50">
                                                <span class="text-gray-400 text-xs font-bold mt-0.5">3.</span>
                                                <span class="font-medium">{{ g.pivot.codeudor3 }}</span>
                                            </li>
                                    ...
                                    <div>
                                        <h4 class="text-[10px] font-black text-gray-400 uppercase mb-3 flex items-center gap-2 tracking-widest">
                                         ...
                                         <ul class="space-y-2 text-sm">
                                            <li v-if="g.pivot.observacion1" class="flex items-start gap-2 p-2 rounded bg-gray-50/30 dark:bg-gray-800/50 border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-1.5 shrink-0"></span>
                                                <span class="text-gray-600 dark:text-gray-400 italic leading-relaxed">{{ g.pivot.observacion1 }}</span>
                                            </li>
                                            <li v-if="g.pivot.observacion2" class="flex items-start gap-2 p-2 rounded bg-gray-50/30 dark:bg-gray-800/50 border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-1.5 shrink-0"></span>
                                                <span class="text-gray-600 dark:text-gray-400 italic leading-relaxed">{{ g.pivot.observacion2 }}</span>
                                            </li>
                                            <li v-if="g.pivot.observacion3" class="flex items-start gap-2 p-2 rounded bg-gray-50/30 dark:bg-gray-800/50 border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-1.5 shrink-0"></span>
                                                <span class="text-gray-600 dark:text-gray-400 italic leading-relaxed">{{ g.pivot.observacion3 }}</span>
                                            </li>
